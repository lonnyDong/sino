...
public class RedisUtil {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            LOGGER.error("error ops redis", var5);
            return false;
        }
    }
    ...
    public boolean hasKey(String key) {
        try {
            ...
            LOGGER.error("error ops redis", var3);
            return false;
        }
    }
    ...
    public <T> T get(String key, Class<T> clazz) {
        ...
        if (value != null) {
            if (clazz.equals(String.class)) {
                ...
                result = JSON.parseObject(value.toString(), clazz);
            }
        }
    ...
    public boolean set(String key, Object value) {
        try {
            ...
            LOGGER.error("error ops redis", var4);
            return false;
        }
    }
    ...
    public boolean set(String key, Object value, long time) {
        try {
            ...
            LOGGER.error("error ops redis", var6);
            return false;
        }
    }
    ...
    public boolean hset(String key, String item, Object value, long time) {
        try {
            ...
            LOGGER.error("error ops redis", var7);
            return false;
        }
    }
